    ...
    return (
        <header>
            ...
            <div className="flex items-center bg-amazon_blue p-1 flex-grow py-2">
                ...
                <div className="hidden sm:flex items-center h-10 rounded-md flex-grow cursor-pointer bg-yellow-400 flex hover:bg-yellow-500">
            ...
            <div className="flex items-center space-x-3 p-2 pl-6 bg-amazon_blue-light text-white text-sm">
                    ...
                    <p className="link hidden lg:inline-flex">Shopper Toolkitt</p>
